    ...
    return (
        <div className="min-h-screen container mx-auto px-4 py-20 max-w-5xl">
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-3 p-2">
                    {THEMES.map((t) => (
                        <button
                            key={t}
                            className={`group flex flex-col items-center gap-2 p-2 rounded-lg transition-colors ${theme === t ? "bg-base-200" : "hover:bg-base-200/60"
                                }`}
                            onClick={() => setTheme(t)}
                        >
                            <div className="relative h-8 w-full rounded-md overflow-hidden shadow-sm border border-base-300" data-theme={t}>
